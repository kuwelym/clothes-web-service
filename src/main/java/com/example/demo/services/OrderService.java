...
public interface OrderService {
    ...
    ResponseEntity<?> createOrder(Long userId, Set<OrderItemDTO> orderItemDTOS, OrderClass classification, DeliveryOption deliveryOption, DeliveryDTO deliveryDTO, StorePickupDTO storePickupDTO, OrderContactDTO orderContactDTO);
