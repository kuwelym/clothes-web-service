 ...
 *
 * @version 1.1
 * Get color name from hex value using android.graphics.Color
 * @author kuwelym
 */
public class ColorUtils {
    ...
    private static ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Corn Flower Blue", 0x64, 0x95, 0xED));
        colorList.add(new ColorName("Corn Silk", 0xFF, 0xF8, 0xDC));
